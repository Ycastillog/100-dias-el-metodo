# Week 1 Content Pack - 100 Dias: El Metodo
...
No necesitas otra promesa grande. Necesitas una forma de volver cuando el animo baja. El Grupo Alpha de 100 Dias: El Metodo empieza por Dia 0, Dia 1 y Dia 7. Comenta CONTROL.
...
**Slide 3:** Fortaleza: ejecutar aunque el animo cambie.

**Slide 4:** Direccion: decidir que merece tu energia.

**Slide 5:** El Metodo empieza en Dia 0: una decision clara.

**Slide 6:** Dia 1 no es pequeno. Es la primera evidencia.

**Slide 7:** Comenta CONTROL y te envio el acceso Alpha.

**Caption:**

Control, Fortaleza y Direccion no son palabras bonitas. Son tres practicas para dejar de vivir apagando incendios. El Grupo Alpha esta abierto para 10 personas. Comenta CONTROL.
...
**Story 2:** Texto: El Metodo empieza cuando identificas el patron, no cuando finges que no existe.

**Story 3:** CTA: Responde CONTROL si quieres entrar al Alpha.
...
Fallar un dia no destruye tu proceso.

Lo que lo destruye es no volver.

La mayoria usa un error como excusa para abandonar todo.

Pero la disciplina real no es perfeccion.
...
Saben que deben ordenar su dia.
Saben que deben dejar de reaccionar al telefono.
Saben que deben sostener una accion diaria.
...
No como motivacion barata.
No como teoria infinita.
No como otro PDF guardado.

Como un marco simple para probar si puedes volver al control desde una accion diaria.

Estoy abriendo un Grupo Alpha de 14 dias para 10 personas.
...
Si quieres entrar, escribeme CONTROL.

## Dia 6 - Carrusel Instagram
...
**Slide 3:** No es para quien quiere resultados sin ejecutar.

**Slide 4:** No es para quien cambia de meta cada semana.

**Slide 5:** Es para quien esta cansado de improvisar.

**Slide 6:** Es para quien quiere volver al marco aunque falle.

**Slide 7:** Si eres esa persona, comenta CONTROL.
...
Sentirte motivado no es una prueba.

Comprar un curso no es una prueba.
