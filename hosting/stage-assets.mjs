...
const assets = await (prelaunch ? loadPrelaunchAssets : loadAssets)(root);
...
console.log(`Staged ${Object.keys(assets).length - 1} allowlisted ${prelaunch ? 'prelaunch' : 'private review'} assets.`);
